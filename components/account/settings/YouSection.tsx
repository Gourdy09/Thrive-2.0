...
import { Animated, ScrollView, Text, TextInput, TouchableOpacity, useColorScheme, View } from 'react-native';
...
function AnimatedDropdown({
    ...
    const totalContentHeight = (options.length * itemHeight) + borderHeight + containerBorder + extraPadding;
                            ...
                            <TouchableOpacity
                                ...
                                style={{
                                    ...
                                    backgroundColor: value === option 
                                        ? colorScheme === "dark" ? "#252830" : "#e8f0ff"
                                        : "transparent"
                                }}
                            >
                                <Text style={{ 
            ...
            >
                ...
                <View style={{ marginBottom: 20 }}>
                    ...
                    <TextInput
                        ...
                        onChangeText={(text) => onBaselineGlucoseChange(text.replace(/[^0-9]/g, ''))}
                        placeholder="100"
                        placeholderTextColor={theme.icon}
                    ...
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 12 }}>
                        {COMMON_RESTRICTIONS.map(restriction => {
                            ...
                            return (
                                <TouchableOpacity
                                    key={restriction}
                                    onPress={() => isSelected ? removeRestriction(restriction) : addRestriction(restriction)}
                                    style={{
