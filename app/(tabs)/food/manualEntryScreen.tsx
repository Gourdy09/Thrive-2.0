...
interface ManualEntryScreenProps {
  // Props can be defined here if needed from navigation
}
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: theme.background }}>
      ...
      <View style={{ padding: 16 }}>
        <Text style={{ color: theme.text, marginBottom: 8 }}>Recipe Name</Text>
        <TextInput
        ...
        <Text style={{ color: theme.text, marginBottom: 8 }}>Instructions</Text>
        <TextInput
          style={{
            backgroundColor: theme.cardBackground,
            color: theme.text,
        ...
        <Text style={{ color: theme.text, marginBottom: 8 }}>Protein (g)</Text>
        <TextInput
          style={{
            backgroundColor: theme.cardBackground,
            color: theme.text,
        ...
        <Text style={{ color: theme.text, marginBottom: 8 }}>Carbs (g)</Text>
        <TextInput
          style={{
            backgroundColor: theme.cardBackground,
            color: theme.text,
        ...
        >
          <Text
            style={{ color: "#900606ff", fontSize: 16, fontWeight: "bold" }}
          >
            Save Recipe
          </Text>
        </TouchableOpacity>
